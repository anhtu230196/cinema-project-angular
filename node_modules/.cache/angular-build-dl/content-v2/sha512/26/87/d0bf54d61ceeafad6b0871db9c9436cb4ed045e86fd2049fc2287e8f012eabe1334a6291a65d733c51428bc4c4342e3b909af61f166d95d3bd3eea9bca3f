...
/* harmony import */ var _pipe_pipe_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pipe/pipe.module */ "./src/app/pipe/pipe.module.ts");
...
const routes = [
    ...
    {
        path: "",
        loadChildren: () => Promise.all(/*! import() | main-main-module */[__webpack_require__.e("common"), __webpack_require__.e("main-main-module")]).then(__webpack_require__.bind(null, /*! ./main/main.module */ "./src/app/main/main.module.ts")).then((m) => m.MainModule),
    },
];
class AppModule {
}
...
/* harmony import */ var _url_youtube_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./url-youtube.pipe */ "./src/app/pipe/url-youtube.pipe.ts");
/* harmony import */ var _safe_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./safe.pipe */ "./src/app/pipe/safe.pipe.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](PipeModule, { declarations: [_url_youtube_pipe__WEBPACK_IMPORTED_MODULE_2__["UrlYoutubePipe"], _safe_pipe__WEBPACK_IMPORTED_MODULE_3__["SafePipe"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"]] }); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UrlYoutubePipe", function() { return UrlYoutubePipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");


class UrlYoutubePipe {
    transform(value) {
...
UrlYoutubePipe.ɵfac = function UrlYoutubePipe_Factory(t) { return new (t || UrlYoutubePipe)(); };
UrlYoutubePipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({ name: "urlYoutube", type: UrlYoutubePipe, pure: true });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UrlYoutubePipe, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"],
        args: [{
                name: "urlYoutube",
            }]
...
module.exports = __webpack_require__(/*! C:\Users\Admin\Documents\Front-End\Angular\Buoi5\src\main.ts */"./src/main.ts");
